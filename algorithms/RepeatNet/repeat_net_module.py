...
import numpy as np
import chainer
from chainer import optimizers, serializers,training,reporter,iterators
...
chainer.backends.cuda.available = False
class RN:
    ...
    def fit(self, data, test):
        ...
        with chainer.using_device('@numpy'):
            ...
            if True:
                ...
                #test = 'data/fiction-with-attributes/prepared/fiction.dat.small.clicks.interaction_attributes_test.txt'
                ...
                trainer.extend(training.extensions.PrintReport(
                    ['epoch', 'iteration', 'main/loss', 'main/loss0', 'main/loss1', 'main/loss2',
                     ...
                     'elapsed_time']),
                    trigger=(1, 'iteration'))
                # trainer.extend(training.extensions.Evaluator(valid_iter, recsys, eval_func=lambda batch: evaluates(valid_dataset,test_dataset,test_batchsize, recsys), converter=converter, 
                # =device), trigger=(1, 'epoch'))
                ...
                trainer.extend(training.extensions.Evaluator(test_iter, self.recsys,
                                                             eval_func=lambda batch: evaluate(self.test_dataset,
                                                                                              ...
                                                                                              prefix='test'),
                                                             converter=converter), trigger=(1, 'epoch'))
